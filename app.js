// === The Electromagnetism · Interactive - Core Application ===
...
const App = {
    ...
    // --- Progress ---
    loadProgress() {
        try { this.progress = JSON.parse(localStorage.getItem('hs-electromagnetism-progress') || '{}'); }
        catch (e) { this.progress = {}; }
    },
    saveProgress() {
        try { localStorage.setItem('hs-electromagnetism-progress', JSON.stringify(this.progress)); } catch (e) {}
    },
